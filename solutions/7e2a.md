...
Examine class \lstinline{StackOverflow} and compare it with your solution.

Running class \lstinline{StackOverflow} from the sample solution three times in succession, I get the following output:
