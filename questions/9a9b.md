...
\vspace{1mm}\noindent\textbf{Step 2.} Next, Create an *interface* called `Tune`.  Implementations of
...
\vspace{1mm}\noindent\textbf{Step 3.} Implement `Tune` with an *abstract* class, `AbstractTune`.
...
\vspace{1mm}
\noindent\textbf{Step 5.} Now your task is to implement *transposition* of tunes; that is, raising or lowering
